...
export async function Tiktok(query) {
  ...
  try {
    ...
    console.log("⚠️ TikWM a échoué, basculement sur la méthode de secours...", err.message);
  }
  ...
  try {
    ...
    // Recherche dynamique du lien sans filigrane peu importe l'ordre dans le tableau
    let nowmLink = null;
    let wmLink = null;
    let audioLink = null;
    ...
    console.log("⚠️ Lovetik a également échoué :", err.message);
  }
